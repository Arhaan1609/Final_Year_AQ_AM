...
export const FleetRoiCalculator: React.FC = () => {
  ...
  const annualSavingsPerEV = (batteryPackCost / 3.5) - (batteryPackCost / 5.8) + (dailyKm * 365 * 0.45); // Includes range efficiency + replacement deferral
  ...
  return (
    <section id="roi" className="py-24 px-6 sm:px-10 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-xl">
        ...
        {/* Right 6 Cols: Real-time ROI Savings Cards */}
        <div className="lg:col-span-6 bg-slate-950 text-white rounded-2xl p-6 sm:p-8 space-y-6 border border-slate-800 shadow-2xl">
          <div>
          ...
          <Link
            href="/dashboard"
            className="w-full inline-flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white font-bold text-xs shadow-md transition-all hover:scale-[1.02] active:scale-95"
          >
